...
import { LOCALAI_BUNDLED_MODEL_TAG } from '@shared/localai'
...
/** D1 "Your data" card — where the bundled model lives (stays in userData, never moved). */
export function bundledModelDir(): string {
  return modelDir()
}
