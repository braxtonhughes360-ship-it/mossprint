...
export const PROFILE_SECURITY_COPY =
  'MOSS encrypts your profile data on this computer (using SQLCipher). Your password and recovery phrase unlock it. For the rest of your files, turn on your computer\'s built-in encryption (FileVault on Mac or Device Encryption on Windows).'
