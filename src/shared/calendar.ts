...
export interface CalendarGoogleStatus {
  ...
  /** False for connections made before the write scope shipped — Settings offers Reconnect. */
  writeCapable: boolean
  /** MOSS-created events still waiting to reach Google (pending or errored pushes). */
