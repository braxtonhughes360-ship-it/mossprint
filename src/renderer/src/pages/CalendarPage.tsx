...
import { DashboardWeeklyScoreCard } from '../components/DashboardWeeklyScoreCard'
...
export function CalendarPage(): React.JSX.Element {
  ...
  const loadError = weekQuery.error ?? sourcesQuery.error ?? monthQuery.error
    ...
    >
      ...
      <div className="moss-arrival-body calendar-arrival-body">
        ...
        {view === 'week' ? (
          ...
          <CalendarMonthPanel glance={monthGlance} onSelectDay={selectDayFromMonth} />
        ) : view === 'goals' ? (
          <div className="calendar-goals-view">
            <DashboardWeeklyScoreCard snapshot={weeklyScore} loading={weeklyScoreLoading} />
            <GoalsWeekPanel
              weekStartKey={weekStartKey}
              onWeekChange={setWeekStartKey}
              onMutate={refreshWeeklyScore}
            />
          </div>
        ) : null}
      </div>
