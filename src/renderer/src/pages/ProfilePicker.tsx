          ...
          <section className="moss-setup-step">
                ...
                <MossListStaggerItem as="li" key={profile.id} className="moss-profile-cell">
                  ...
                  {manageMode && (
                    <MossButton
                      ...
                      size="xs"
                      subtle
                      className="moss-profile-remove-action"
            ...
            {removing ? (
              <form className="moss-profile-remove-confirm" onSubmit={(e) => void handleRemove(e)}>
                ...
                <MossToolbar label="Remove profile actions" className="moss-profile-remove-actions">
                  <MossToolbar.Group label="Remove profile">
                    <MossButton variant="quiet" onClick={cancelRemove} disabled={deleting}>
                      Cancel
                    </MossButton>
                    <MossButton
                      type="submit"
                      variant="danger"
                      disabled={confirmName.trim() !== removing.displayName}
                      busy={deleting}
                      busyLabel="Removing…"
                    >
                      Remove profile
