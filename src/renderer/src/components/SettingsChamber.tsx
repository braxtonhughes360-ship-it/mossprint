...
import { MossPanelTransition } from './MossPanelTransition'
...
export function SettingsChamber(): React.JSX.Element {
  ...
  const select = (id: SettingsSectionId): void => {
    ...
    contentRef.current?.scrollIntoView({
      behavior: routeTransitionFull ? 'smooth' : 'auto',
      block: 'start'
    })
  }
    ...
    <div className="moss-settings-chamber moss-arrival-slab">
      <div className="settings-shell">
        ...
        <div className="settings-content" ref={contentRef}>
          <MossPanelTransition transitionKey={active}>
            ...
            {active === 'privacy' && (
              <MossCard className="settings-card settings-card-memory">
                <header className="settings-card-head">
                  ...
                  <p className="settings-card-copy">
                    ...
                    see where that file lives, open it in your file manager, move it to a folder
                    you choose, and check it&apos;s healthy.
                  </p>
                </header>
                <LocalDataPanel />
              </MossCard>
