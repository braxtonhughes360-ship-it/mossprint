  ...
  return (
    ...
    >
      ...
      <p className="nutrition-describe-hint">
        {llmModel
          ? `Smart parsing on — local model (${llmModel.split(':')[0]}), nothing leaves this computer.`
          : 'Basic parsing — install Ollama (ollama.com) and a small model for smarter meal parsing, fully offline.'}
      </p>
