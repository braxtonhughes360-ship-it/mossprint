  ...
  if (!overview.hasGoals) {
    return (
      <section className="money-instrument-panel money-savings-panel money-savings-panel--empty">
        ...
        <button
          type="button"
          className="money-button money-button--accent"
          disabled={busy}
          ...
          {row.guidance.targetAssignCents > 0 && (
            <div className="money-savings-contribute">
              <form className="money-savings-contribute-form" onSubmit={handleContribute}>
                ...
                <button
                  type="submit"
                  className="money-button money-button--accent money-button--compact"
    ...
    >
      ...
      >
        ...
        <div className="money-savings-form-actions">
          <button type="button" className="money-button money-button--ghost" onClick={onClose}>
            Cancel
          </button>
          <button type="submit" className="money-button money-button--accent" disabled={busy}>
            Create goal
          </button>
        </div>
      </form>
