  ...
  return (
    <section className="settings-card" id="settings-profiles">
      ...
      <div className="moss-profile-settings-active">
        ...
        <button type="button" className="btn-secondary" onClick={() => void switchProfile()} disabled={busy}>
          Switch profile
        </button>
      </div>
      ...
      <div className="settings-actions mt-6">
        <button type="button" className="btn-secondary" onClick={() => navigate('/setup?new=1')}>
          Add another profile
        </button>
      </div>
