        ...
        return (
          ...
          >
            ...
            {entries.length === 0 ? (
              ...
              <MossListStagger as="ul" className="nutrition-entry-list">
                {entries.map((entry) => (
                  <MossListStaggerItem key={entry.id} as="li" className="nutrition-entry-row">
                    <button
                      type="button"
                    ...
                    >
                      <span className="nutrition-delete-glyph" aria-hidden>
                        ×
                      </span>
                    </MossButton>
                  </MossListStaggerItem>
