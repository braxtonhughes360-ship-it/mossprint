...
export function MoneyDescribeField({
  ...
  return (
    <section className="money-describe" aria-label="Describe an entry">
      {thinking ? (
        <div
          className="money-describe-pending"
          aria-busy="true"
          aria-label="Preparing entry preview"
        >
          <MossSkeleton variant="block" width="5.5rem" height="2.25rem" />
          <MossSkeleton variant="block" width="6.25rem" height="2.25rem" />
          <MossSkeleton variant="block" width="9rem" height="2.25rem" />
          <MossSkeleton variant="block" width="8rem" height="2.25rem" />
          <MossSkeleton variant="block" width="7.5rem" height="2.25rem" />
          <MossSkeleton variant="block" width="4.5rem" height="2.25rem" />
        </div>
      ) : !previewOpen ? (
        <form
