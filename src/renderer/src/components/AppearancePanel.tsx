  ...
  return (
    <div className="settings-stack">
      <MossCard
        ...
        footer={
          <MossToolbar label="Profile actions" className="settings-actions">
            <MossToolbar.Group label="Setup">
              <MossButton tone="neutral" onClick={() => navigate('/setup?rerun=1')}>
                Run setup again
              </MossButton>
            </MossToolbar.Group>
          </MossToolbar>
...
export function AppearancePanel(): React.JSX.Element {
  ...
  return (
    <div className="settings-stack">
      ...
      <MossToolbar label="Appearance actions" className="settings-actions">
        <MossToolbar.Group label="Defaults">
          <MossButton tone="neutral" onClick={resetPreferences}>
