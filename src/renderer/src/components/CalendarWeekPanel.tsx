...
export function CalendarWeekPanel({
  ...
  // QA2-05: describe is the whole bar; time/day/length live behind "Adjust".
  // Auto-opens when the model fills them — they're the correction surface.
  ...
  return (
    <section className="calendar-week-panel" aria-label="Week schedule">
      ...
      >
        ...
        <MossToolbar className="calendar-quick-add-actions" label="Quick-add event actions">
          <MossToolbar.Group label="Event actions">
            <MossButton
              type="submit"
              busy={thinking}
              busyLabel="Thinking…"
        ...
        {manualOpen && (
          <div className="calendar-quick-add-manual">
            <label className="calendar-quick-add-field calendar-quick-add-field--compact">
              ...
              <MossDateField
                name="startTime"
                type="time"
                className="calendar-quick-add-time"
                disabled={busy}
                value={startTime}
                        ...
                        <button
                          ...
                          title={
                            editable
                              ...
                              : `${event.title} — From a connected calendar; edit it there, then refresh MOSS`
                          }
                        >
