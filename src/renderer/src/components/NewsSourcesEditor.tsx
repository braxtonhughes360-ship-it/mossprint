          ...
          {selectedInterests.has('local') && (
            <div className="moss-setup-news-block moss-setup-local-block">
              ...
              <div className="moss-setup-local-lookup-row">
                ...
                <button
                  type="button"
                  className="moss-setup-btn moss-setup-btn--secondary moss-setup-btn--compact"
              ...
              {sources.map((source) => (
                <li key={source.id} className="moss-news-subscribed-row">
                    ...
                    >
                      {source.lastError
                        ...
                        : source.lastFetchedAt
                          ? `Synced ${new Date(source.lastFetchedAt).toLocaleString()}`
                  ...
                  {source.lastError ? (
                    <button
                      type="button"
                      className="moss-news-subscribed-retry"
                      disabled={editorBusy}
                  ...
                  <button
                    type="button"
                    className="moss-news-subscribed-remove"
                    disabled={editorBusy}
