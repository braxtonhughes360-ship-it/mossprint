...
const CAL = {
  ...
  header: 'var(--moss-glyph-accent)',
  headerDeep: 'var(--moss-glyph-accent-deep)',
  today: 'var(--moss-glyph-signal)'
}
  ...
  return (
    ...
    >
      ...
      <svg viewBox="0 0 32 32" fill="none" className="moss-nav-glyph-svg moss-char-mark" aria-hidden>
        <ellipse cx="16" cy="27.5" rx="9" ry="1.6" fill="var(--moss-glyph-shadow)" opacity="0.1" />
