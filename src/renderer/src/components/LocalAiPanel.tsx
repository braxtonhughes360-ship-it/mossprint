...
/** Settings → Smart parsing: runtime status, the built-in helper, and per-surface toggles. */
  ...
  return (
    <div className="settings-stack">
      <MossCard className="settings-card">
        ...
        {!working && !hasBundled && (
          <>
            <MossToolbar label="Smart parsing setup" className="settings-actions">
        ...
        <MossToolbar label="Smart parsing status" className="settings-actions">
          <MossToolbar.Group label="Status">
            <MossButton
              tone="neutral"
              busy={busy}
              busyLabel="Checking…"
      ...
      <MossCard className="settings-card">
        ...
        <div className="preference-field preference-field-module">
          <MossCheckbox
            label="Smart parsing"
            description="Master switch for smart parsing."
      ...
      <MossCard className="settings-card settings-card-trust">
