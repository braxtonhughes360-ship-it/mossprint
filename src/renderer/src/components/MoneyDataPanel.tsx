      ...
      {!parse ? (
        ...
        >
          ...
          <div className="money-data-actions">
            <button type="button" className="money-button" onClick={handlePick} disabled={working}>
              Choose a CSV file…
            </button>
          </div>
        </section>
        ...
        <section className="money-data-card money-data-import">
          <div className="money-data-import-head">
            ...
            <button type="button" className="money-button money-button--ghost" onClick={cancelImport}>
              Cancel
            </button>
          </div>
          ...
          <div className="money-data-actions">
            <button type="button" className="money-button" onClick={handleImport} disabled={importDisabled}>
          ...
          <details className="money-data-advanced">
            ...
            <div className="money-data-options">
              ...
              <label className="money-data-checkbox">
                <input
                  type="checkbox"
                ...
                />
                <span>Skip rows already in my ledger</span>
              </label>
            </div>
          </details>
        </section>
