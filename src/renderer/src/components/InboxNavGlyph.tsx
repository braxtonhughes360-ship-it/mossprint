...
const MAIL = {
  ...
  paperDeep: 'var(--moss-glyph-paper-deep)',
  ink: 'var(--moss-glyph-ink)',
  flap: 'var(--moss-glyph-warm)',
  flapDeep: 'var(--moss-glyph-warm-deep)',
  dot: 'var(--moss-glyph-signal)'
}
  ...
  return (
    ...
    >
      ...
      <svg viewBox="0 0 32 32" fill="none" className="moss-nav-glyph-svg moss-char-mark" aria-hidden>
        <ellipse cx="16" cy="26.5" rx="9.5" ry="1.6" fill="var(--moss-glyph-shadow)" opacity="0.1" />
        ...
        <circle cx="25.5" cy="9.5" r="3.4" fill={MAIL.dot} stroke="var(--moss-glyph-highlight)" strokeWidth="1" />
      </svg>
    </span>
  )
}
