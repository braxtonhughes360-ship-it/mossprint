  ...
  return (
    <div className="notes-attachment notes-block-image" data-shape={style.shape} data-size={style.size}>
      <figure className="notes-attachment-figure notes-inline-figure" tabIndex={0}>
        ...
        />
        {attachment && (
          <div className="notes-attachment-toolbar" role="toolbar" aria-label="Image style">
            <div className="notes-attachment-toolbar-group" role="group" aria-label="Shape">
            ...
            <div className="notes-attachment-toolbar-group" role="group" aria-label="Size">
            ...
            {attachment.sketch && (
              <div className="notes-attachment-toolbar-group" role="group" aria-label="Sketch">
                <button
                  type="button"
  ...
  return (
    <div className="notes-attachment notes-block-image" data-shape="rounded" data-size="medium">
      ...
      <canvas
        ...
        aria-label="Drawing"
      />
        <div className="notes-attachment-toolbar" role="toolbar" aria-label="Drawing">
          <div className="notes-attachment-toolbar-group" role="group" aria-label="Sketch">
            <button
              type="button"
              className="notes-attachment-style-btn"
