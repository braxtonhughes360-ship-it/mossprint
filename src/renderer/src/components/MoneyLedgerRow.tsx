...
import { MossListStaggerItem } from './MossListStagger'
 ...
 */
export const MoneyLedgerPaycheckRow = memo(function MoneyLedgerPaycheckRow({
  paycheck,
  accountName
}: {
  ...
  return (
    <MossListStaggerItem as="li" className="money-ledger-entry money-ledger-entry--paycheck">
      <div
...
export const MoneyLedgerRow = memo(function MoneyLedgerRow({
  txn,
  balanceCents,
  categoryMap,
  accountMap,
  ...
  return (
    <MossListStaggerItem
      as="li"
      className={['money-ledger-entry', expanded ? 'money-ledger-entry--open' : '']
        .filter(Boolean)
        .join(' ')}
    >
      <div
