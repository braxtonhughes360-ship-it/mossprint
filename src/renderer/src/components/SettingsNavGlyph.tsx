...
const SET = {
  metal: 'var(--moss-glyph-metal)',
  metalDeep: 'var(--moss-glyph-metal-deep)',
  ink: 'var(--moss-glyph-ink)',
  hub: 'var(--moss-glyph-accent)',
  hubDeep: 'var(--moss-glyph-accent-deep)'
}
  ...
  return (
    ...
    >
      ...
      <svg
        ...
        aria-hidden
      >
        <ellipse cx="16" cy="28" rx="8" ry="1.5" fill="var(--moss-glyph-shadow)" opacity="0.1" />
        {TEETH.map((a) => (
          <rect
            key={a}
            x="14"
