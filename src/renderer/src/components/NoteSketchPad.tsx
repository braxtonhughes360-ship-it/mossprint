...
export function NoteSketchPad({
  ...
  return (
    ...
    >
      ...
      <div className="notes-sketch-toolbar" role="toolbar" aria-label="Sketch tools">
        ...
        <div className="notes-attachment-toolbar-group" role="group" aria-label="Stroke width">
        ...
        <div className="notes-attachment-toolbar-group" role="group" aria-label="Ink color">
        ...
        <div className="notes-attachment-toolbar-group" role="group" aria-label="History">
          <button
            type="button"
