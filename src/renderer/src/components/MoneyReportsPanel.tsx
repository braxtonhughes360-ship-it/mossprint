...
export function MoneyReportsPanel({
  ...
  return (
    <div className="money-reports-panel">
      ...
      <MossToolbar className="money-reports-toolbar" label="Report filters">
        <MossToolbar.Group label="Date range">
        ...
        <MossToolbar.Group className="money-reports-toolbar-actions" label="Filter actions">
          {activeFilterCount > 0 && (
            <MossButton type="button" variant="quiet" size="sm" onClick={clearFilters}>
              Clear
            </MossButton>
          )}
          <MossButton
        ...
        <div className="money-reports-advanced" id="money-reports-advanced">
          ...
          <div className="money-reports-presets">
            ...
            >
              ...
              />
              <MossButton type="submit" variant="quiet" disabled={busy || !presetName.trim()}>
                Save preset
              </MossButton>
            </form>
          </div>
