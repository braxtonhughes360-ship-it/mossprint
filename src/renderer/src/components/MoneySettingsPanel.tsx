    ...
    <div className="money-settings-panel">
      ...
      <section className="money-data-card money-settings-card">
        ...
        <p className="money-data-trust">
          MOSS does not connect to your bank — you choose what to type, import, or quote. Limits are stated plainly,
      ...
      <section className="money-data-card money-settings-card">
        ...
        <MossCheckbox
          className="preference-field preference-field-module money-settings-advanced"
          label="Show advanced money tools"
          description="Also available in Settings → Modules."
