...
const PREFIX_TO_FILE = {
  ...
  notes: 'NotesPage.css',
  settings: 'ShellPlaceholderPage.css',
  'moss-settings': 'ShellPlaceholderPage.css',
  'settings-arrival': 'ShellPlaceholderPage.css',
  'news-reader': 'ShellPlaceholderPage.css',
  'news-sources': 'ShellPlaceholderPage.css',
  'moss-setup': 'SetupWizard.css',
  capture: 'CapturePage.css',
  'local-ai': 'ShellPlaceholderPage.css',
  'localai': 'ShellPlaceholderPage.css'
}
...
function main() {
  ...
  const fileToPage = {
    ...
    'ShellPlaceholderPage.css': 'pages/ShellPlaceholderPage.tsx',
