...
<img src="build/moss-logo.png" width="820" alt="MOSS — Modular Operating System for Self">

# Mossprint

**The public repository for MOSS.**

*MOSS is your day on one quiet screen — and none of it ever leaves your computer.*
...
![Repository: Mossprint](https://img.shields.io/badge/Repository-Mossprint-d08c3f)
...
Mossprint is the public repository for **MOSS**, one warm home screen for the things you actually check every day. Open MOSS in the morning, see your day, get on with it. There is **no MOSS account**, **no ads**, and **no feed** engineered to keep you scrolling — your data lives in a database on **your own computer**, and we don't run a server that holds your life.
